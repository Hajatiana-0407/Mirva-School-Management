  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-secondary-900">Examens et Notes</h1>
        <button
      ...
      <div className="bg-light p-3 md:p-6 rounded-lg shadow-sm border">
        ...
        {activeTab === 'bulletins' && (
          <div className="text-center py-12">
            <FileText className="w-16 h-16 mx-auto text-secondary-400 mb-4" />
            <h3 className="text-lg font-medium text-secondary-900 mb-2">Bulletins scolaires</h3>
            <p className="text-secondary-600 mb-4">Générez et consultez les bulletins de notes des élèves</p>
            <button className="bg-primary-600 text-light px-3 md:px-6 py-3 rounded-lg hover:bg-primary-700 transition-colors">
      ...
      >
        {activeTab === 'exams' ? (
          <form className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-secondary-700 mb-1">Nom de l'examen</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-secondary-700 mb-1">Coefficient</label>
                <input
                  type="number"
                  min="1"
                  max="5"
          ...
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-secondary-700 mb-1">Sur</label>
                <input
                  type="number"
                  defaultValue="20"
                  className="w-full px-3 py-2 border border-secondary-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
