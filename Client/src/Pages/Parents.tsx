  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-secondary-900">Gestion des parents</h1>
        <button
      ...
      >
        <form className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-secondary-700 mb-1">Relation</label>
          ...
          <div>
            <label className="block text-sm font-medium text-secondary-700 mb-1">Enfants</label>
            <select className="w-full px-3 py-2 border border-secondary-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
