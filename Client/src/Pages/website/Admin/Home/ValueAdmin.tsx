        ...
        <div className="space-y-4 md:space-y-6">
            ...
            <div className="">
                {action?.isLoading ? (
                    ...
                    <div className="text-center text-gray-500 py-12">Aucune valeur enregistrée.</div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {values.map((value) => (
                            <div
                                key={value.id_valeur}
                                className="relative text-center bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 group"
                            >
                                ...
                                {permission.update &&
                                    <form onSubmit={toggleActive} className="flex justify-center mt-5">
                                        ...
                                        <button
                                            type="submit"
                                            className={`ml-2 p-2 rounded-full border ${value.actif ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-400'} hover:bg-blue-50 transition`}
            ...
            {activeIcon &&
                <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
                    <div className="bg-white rounded-xl p-8 relative flex flex-col items-center">
                        <button
                        ...
                        <DynamicLucideIcon iconName={activeIcon} color='blue' size='16' />
                        <div className="mt-4 text-gray-700">{activeIcon}</div>
                    </div>
                </div>
            }
