...
const COLORS = [
    'text-secondary-800', 'text-primary-500', 'text-green-500', 'text-pink-500', 'text-yellow-500',
    ...
    return (
        <div className="w-full">
            ...
            <div className="mb-4 flex flex-wrap gap-2 items-center">
              ...
              ${selectedColor === clr ? 'border-primary-500 scale-110' : 'border-secondary-200'}
            `}
            ...
            {/* Recherche */}
            <div className="mb-3 flex items-center bg-secondary-100 rounded-lg px-3 py-2">
                <Search className="w-5 h-5 text-secondary-400 mr-2" />
                <input
                    type="text"
                    ...
                    className="bg-transparent outline-none w-full text-secondary-700"
                />
            </div>
            ...
            <div className="grid grid-cols-6 sm:grid-cols-8 gap-3 max-h-64 overflow-y-auto">
                {iconsToShow.length > 0 ? (
                  ...
                  ${isSelected ? 'bg-primary-100 border-primary-400' : 'bg-light border-secondary-200 hover:bg-primary-50'}
                  focus:outline-none`}
                            >
                                <LucideIcon className={`w-7 h-7 ${selectedColor} mb-1`} />
                                <span className="text-[10px] text-secondary-500 truncate">{iconName}</span>
                            </button>
                        );
                    })
                ) : (
                    <div className="col-span-full text-center text-secondary-400 py-6">
            ...
            {totalPages > 1 && (
                <div className="flex justify-center items-center gap-4 mt-4">
                    <button
                        ...
                        disabled={page === 0}
                        className="px-3 py-1 rounded bg-primary-500 text-light hover:bg-primary-600 disabled:opacity-50"
                    >
            ...
            {value && (
                <div className="mt-4 flex items-center gap-2">
                    <span className="text-sm text-secondary-600">Icône sélectionnée :</span>
