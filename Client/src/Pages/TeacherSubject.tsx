            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                    ...
                    <div className="col-span-2 rounded  bg-white flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <div className="rounded mb-2">
                                <div className="flex px-2 py-1 sm:px-4 smpy-2 _classe border-b text-base font-semibold mb-2 rounded-t-2xl">
                                    ...
                                    {classes.map((classe: ClasseType, idx: number) => {
                                        ...
                                        return (
                                            <label
                                                ...
                                                className={`flex items-center px-2 py-1 sm:px-4 smpy-2 _classe bg-white rounded border border-gray-200 hover:shadow-sm transition mb-1 cursor-pointer ${disabled ? "opacity-50 pointer-events-none" : ""}`}
                                ...
                                <div className="flex gap-2 justify-end mt-3">
                                    <button
                                        className="bg-gray-200 text-gray-700 font-semibold px-2 py-1 sm:px-4 smpy-2 _classe rounded-lg flex items-center space-x-2 hover:bg-gray-300 transition-colors"
                                    ...
                                    <button
                                        className={`bg-blue-600 text-white font-semibold px-2 py-1 sm:px-4 smpy-2 _classe rounded-lg flex items-center space-x-2 transition-colors ${isValidateDisabled ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-700"}`}
                ...
                <div className="col-span-3 max-lg:border-t lg:border-l flex flex-col justify-between">
                    ...
                    <div className="flex justify-end py-3">
                        <button
                            className="bg-red-600 text-white px-2 py-1 sm:px-4 smpy-2 _classe rounded-lg space-x-2 hover:bg-red-700 transition-colors flex items-center disabled:bg-red-300"
