...
const LevelDetails: React.FC = () => {
    ...
    if (!level) {
        return (
            <div className="p-3 md:p-6">
                <div className="text-center text-secondary-500">Niveau introuvable.</div>
            </div>
        );
    }
        ...
        <div className="space-y-4 md:space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                <div className="col-span-2 bg-light border rounded-lg p-4 shadow-sm">
                    ...
                    <p className="text-sm text-secondary-600 mb-4">{level.description || "Aucune description fournie."}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        <div className="bg-secondary-50 border rounded-lg p-3 text-center">
                            ...
                            <div className="text-md text-secondary-500">Classes</div>
                        </div>
                        ...
                        <div className="bg-secondary-50 border rounded-lg p-3 text-center">
                            ...
                            <div className="text-md text-secondary-500">Matières</div>
                        </div>
                        ...
                        <div className="bg-secondary-50 border rounded-lg p-3 text-center">
                            ...
                            <div className="text-md text-secondary-500">Professeurs</div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        {subjects.length === 0 ? (
                            <div className="text-sm text-secondary-500">Aucune matière pour ce niveau.</div>
                        ) : (
                    ...
                    <div className="mt-6">
                        ...
                        {classes.length === 0 ? (
                            <div className="text-sm text-secondary-500">Aucune classe pour ce niveau.</div>
                        ) : (
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
                                {classes.map((c) => (
                                    <Link
                                        ...
                                        key={c.id_classe}
                                        className="bg-light border rounded-lg p-3 flex items-center justify-between hover:bg-secondary-100 transition-all duration-150"
                                    >
                                        <div>
                                            <div className="font-medium">{c.denomination}</div>
                                            <div className="text-xs text-secondary-500">ID: {c.id_classe}</div>
                                        </div>
                ...
                <aside className="bg-light border rounded-lg p-4 shadow-sm">
                    ...
                    <div className="text-sm text-secondary-700 space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="text-xs text-secondary-500">Cycle</div>
                            <div className="font-medium">{level.cycle}</div>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="text-xs text-secondary-500">Créé le</div>
                            <div className="text-xs text-secondary-500">{level?.created_at ? new Date(level.created_at).toLocaleDateString() : "-"}</div>
                        </div>
                    </div>
