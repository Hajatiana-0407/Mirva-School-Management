...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-light shadow-lg sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {auth.isLoggedIn &&
              <Link
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-secondary-500 flex items-center justify-end">
            ...
            {auth.isLoggedIn ?
              <Link
                ...
                className="text-sm font-medium hover:text-primary-600 border border-primary-600 text-light bg-primary-600 hover:bg-light p-1 rounded flex items-center gap-2 justify-center transition-colors duration-200"
              >
                <LayoutDashboard className='w-5 h-5' />
              </Link>
              : <Link
                to="/back-office/singin"
                className="text-sm font-medium text-light bg-primary-600 py-2 px-4 rounded flex items-center gap-2 justify-center transition-colors duration-200"
              >
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-md text-secondary-600 hover:text-primary-600 hover:bg-primary-50 transition-colors duration-200"
            >
