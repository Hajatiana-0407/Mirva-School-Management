        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {school.facebook &&
                <a href={school.facebook} target='_blank' className="text-blue-300 hover:text-white transition-colors duration-200">
                  <Facebook className="h-5 w-5" />
                </a>
              }
              {school.twitter &&
                <a href={school.twitter} target='_blank' className="text-blue-300 hover:text-white transition-colors duration-200">
                  <Twitter className="h-5 w-5" />
                </a>
              }
              {school.instagram &&
                <a href={school.instagram} target='_blank' className="text-blue-300 hover:text-white transition-colors duration-200">
                  <Instagram className="h-5 w-5" />
                </a>
              }
              {school.youtube &&
                <a href={school.youtube} target='_blank' className="text-blue-300 hover:text-white transition-colors duration-200">
            ...
            <div className="space-y-3">
              {school.adresse &&
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-blue-100">{school.adresse}</span>
                </div>
              }
              {school.telephone &&
                <div className="flex items-center space-x-3">
                  <Phone className="h-5 w-5 text-blue-300 flex-shrink-0" />
                  <span className="text-blue-100"> {school.telephone} </span>
                </div>
              }
              {school.email &&
                <div className="flex items-center space-x-3">
                  <Mail className="h-5 w-5 text-blue-300 flex-shrink-0" />
                  <span className="text-blue-100">{school.email}</span>
                </div>
              }
            </div>
          </div>
