import { BookOpen, ListTreeIcon, Plus, Save } from "lucide-react"
                        ...
                        {subjects.map((subject: SubjectType, key: number) => {
                            if (
                                ...
                                >
                                    ...
                                    <button
                                        type="button"
                                        className="text-gray-500 bg- px-2 py-1 bg-gray-50 transition-all cursor-pointer hover:bg-white flex gap-2 border rounded"
